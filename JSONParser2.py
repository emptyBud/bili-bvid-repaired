...
def dealwithauapi(d: dict, d2: dict):
    ...
    def rep(k: str, nonev='', k2: str = None, nonev2=None, f: Callable = None, l: StrList = [], l2: StrList = [], strict: bool = False, d: dict = d, d2: dict = d2):  # noqa: E741
        "检查是否需要覆盖并覆盖"
        for s in l:
...
def getindexfromsongs(l: list, id: int) -> int:  # noqa: E741
    k = 1
    for song in l:
        if song['id'] == id:
            return k
...
def getchs(l: list, d: dict):  # noqa: E741
...
def getuvl(d: dict, l: list):  # noqa: E741
